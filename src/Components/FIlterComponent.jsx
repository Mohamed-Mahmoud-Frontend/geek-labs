  ...
  return (
    <div className="filter rounded ">
      ...
      <div className="border-l p-2">
        ...
        <p className="flex item-center gap-2 text-[12px]"
      ...
      <div className="flex flex-col">
        ...
        <div className="text-white font-light flex gap-2">
          <input type="radio" id="Large" name="marketCap" value="Large" className="text-[#333] border-[#333]" />
      ...
      <div className="flex flex-col">
        <div className="flex flex-col">
          ...
          <div className="text-white font-light flex gap-2">
            <input type="radio" id="LowRisk1" name="riskLevel" value="Low Risk" />
            <label htmlFor="LowRisk1">Low Risk</label>
          </div>
          <div className="text-white font-light flex gap-2">
            <input type="radio" id="LowRisk2" name="riskLevel" value="Low Risk" />
            <label htmlFor="LowRisk2">Low Risk</label>
          </div>
          <div className="text-white font-light flex gap-2">
            <input type="radio" id="LowRisk3" name="riskLevel" value="Low Risk" className="text-[#333] border-[#333]" />
...
<p>Big Option Buys</p>
<p className="bg-[#53ACFF] text-white  p-2 rounded">Merger Arbitrage
</p>
<p>Short Reports
</p>
</div>
...
<button className="bg-[#53ACFF] text-white p-2 w-40 rounded">Apply</button>
</div>
